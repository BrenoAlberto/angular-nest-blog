...
export class CreatePostDialogComponent implements OnInit {
    ...
    constructor(@Inject(MAT_DIALOG_DATA) public data: { editPostDto: EditPostDto }, private dialogRef: MatDialogRef<CreatePostDialogComponent>, private postService: PostService) { }
